...
public class DomainTestData {
    ...
    public void fillUsers() {
        ...
        Set<User> geenratedUsers = uc.getData();
        users.addAll(geenratedUsers);
    }
    ...
    public void fillTaskStatuses() {
        ...
        taskStatus = taskRelatedFactory.createTaskStatus(Constants.TASK_STATUS_FINISHED);
        taskStatusList.add(taskStatus);

        taskStatus = taskRelatedFactory.createTaskStatus(Constants.TASK_STATUS_NOT_STARTED);
        taskStatusList.add(taskStatus);

        taskStatus = taskRelatedFactory.createTaskStatus(Constants.TASK_STATUS_ONGOING);
        taskStatusList.add(taskStatus);

        taskStatus = taskRelatedFactory.createTaskStatus(Constants.TASK_STATUS_PAUSED);
        taskStatusList.add(taskStatus);
    }
    ...
    public void fillTaskTypes() {
        ...
        taskType = taskRelatedFactory.createTaskType(Constants.TASK_TYPE_FINISHED);
        taskTypes.add(taskType);

        taskType = taskRelatedFactory.createTaskType(Constants.TASK_TYPE_HOME);
        taskTypes.add(taskType);

        taskType = taskRelatedFactory.createTaskType(Constants.TASK_TYPE_WORK);
        taskTypes.add(taskType);

        taskType = taskRelatedFactory.createTaskType(Constants.TASK_TYPE_PAUSED);
        taskTypes.add(taskType);
    ...
    public void fillTaskPriorities() {
        ...
        taskPriority = taskRelatedFactory.createTaskPriority(Constants.TASK_PRIORITY_HIGH);
        taskPriorityList.add(taskPriority);

        taskPriority = taskRelatedFactory.createTaskPriority(Constants.TASK_PRIORITY_MEDIUM);
        taskPriorityList.add(taskPriority);

        taskPriority = taskRelatedFactory.createTaskPriority(Constants.TASK_PRIORITY_LOW);
        taskPriorityList.add(taskPriority);

        taskPriority = taskRelatedFactory.createTaskPriority(Constants.TASK_PRIORITY_NONE);
        taskPriorityList.add(taskPriority);
    ...
    public void fillTasks() {
        ...
        task = taskFactory.createTask(taskAttributes);
        tasksList.add(task);
